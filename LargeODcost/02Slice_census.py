...
while i < totaln:
	...
	#arcpy.FeatureClassToFeatureClass_conversion(input, outputgdb, os.path.splitext(os.path.split(input)[1])[0]+"_"+str(i), "{0} IN ({1})".format(str(ID), str(criteria[1:len(criteria)-1])))
